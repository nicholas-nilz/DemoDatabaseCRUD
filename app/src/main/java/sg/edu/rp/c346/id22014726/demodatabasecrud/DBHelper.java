package sg.edu.rp.c346.id22014726.demodatabasecrud;
...
import sg.edu.rp.c346.id22014726.demodatabasecrud.Note;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_NOTE_CONTENT = "note_context";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createNoteTableSql = "CREATE TABLE " + TABLE_NOTE + "(" + COLUMN_ID
